...
<x-layout>
    ...
    <x-page-title text='Students SoftDeleted list'></x-page-title>
    ...
    <div class="container mt-5">
        <h2>Students SoftDeleted list</h2>
            ...
            <tbody>
                @foreach ($students as $student)
                    <tr>
                        ...
                        <td id="createdate">{{ $student->deleted_at }}</td>
