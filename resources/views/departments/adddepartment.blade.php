...
@section('adddepartment')
    ...
    <form class="row g-3 w-a inputform" method="post" action="{{ route('departments.store') }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" value="{{ old('departmentname') }}" class="form-control" name="departmentname"
                id="inputDepartment" required>
        </div>
        <div class="col-md-6 mb-3">
            <label for="inputOwner" class="form-label">Owner</label>
            <input type="text" value="{{ old('departmentowner') }}" class="form-control" name="departmentowner"
