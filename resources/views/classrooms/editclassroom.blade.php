...
@section('editclassroom')
    <form class="row g-3 w-a inputform" method="POST" action="{{ route('classrooms.update', $classroom->id) }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" value="{{$classroom->class_name}}" name="classname" id="inputclass" required>
        </div>
        <div class="col-md-6 mb-3">
            <label for="inputOwner" class="form-label">Edit Owner</label>
            <input type="text" class="form-control" value="{{$classroom->class_owner}}" name="classowner" id="inputOwner" required>
        </div>
        <div class="col-12">
